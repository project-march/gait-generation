...
class ModifiableSubgait(Subgait):
    ...
    @classmethod
    def empty_subgait(cls, gait_generator, robot, duration=8, gait_type='walk_like', gait_name='pr_event_workshop',
                      subgait_name='pr_event_workshop', version='pr_event_workshop', description='Just a simple gait'):
        if robot is None:
